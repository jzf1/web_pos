jQuery(document).ready(function(){
    ...
    for (var i=0;i<receipt.gifts.length;i++){
       ...
       $('#table3').find('tbody').append('<tr><td>save '+ receipt.save+'$</td>','<td>cost '+ receipt.cost+'$</td></tr>');

})
//        else if($('table').data('no.')==2) {
//                  for (var i=0;i<receipt.cart_Items.length;i++){
//                     $(this).append(receipt.gifts[i]);
//                  }
//        } else {
//              $(this).append(receipt.cost);
//              $(this).append(receipt.save);
//        }
